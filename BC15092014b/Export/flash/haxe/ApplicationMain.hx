...
class ApplicationMain {
	...
	static var mPreloader:scripts.StencylPreloader;
	...
	public static function main() {
		...
		//nme.Lib.setPackage("Stencyl", "BC15092014b", "com.yourcompany.gamename", "1.0");
		...
		if (loaded < total || true) /* Always wait for event */ {
			call_real = false;
			mPreloader = new scripts.StencylPreloader();
...
class DocumentClass extends Universal { }
