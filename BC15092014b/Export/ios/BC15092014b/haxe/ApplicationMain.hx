...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Stencyl", "BC15092014b", "hk.com.playpenstudios.untilall", "1.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Unitl All", null, { width: 320, height: 480 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (Universal, []);
			}
