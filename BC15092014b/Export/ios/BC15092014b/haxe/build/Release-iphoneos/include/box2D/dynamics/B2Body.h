...
class HXCPP_CLASS_ATTRIBUTES  B2Body_obj : public hx::Object{
	...
	public:
		...
		virtual Void setAlwaysActive( bool flag);
		Dynamic setAlwaysActive_dyn();

		virtual bool isIgnoringGravity( );
		Dynamic isIgnoringGravity_dyn();

		virtual Void setIgnoreGravity( bool flag);
		Dynamic setIgnoreGravity_dyn();

		virtual bool isPaused( );
		Dynamic isPaused_dyn();

		virtual Void setPaused( bool flag);
		...
		virtual Void setPositionFast( ::box2D::common::math::B2Vec2 position);
