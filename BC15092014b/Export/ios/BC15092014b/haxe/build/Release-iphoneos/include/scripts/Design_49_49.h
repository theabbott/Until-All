...
#define INCLUDED_scripts_Design_49_49
...
HX_DECLARE_CLASS1(scripts,Design_49_49)
namespace scripts{


class HXCPP_CLASS_ATTRIBUTES  Design_49_49_obj : public ::com::stencyl::behavior::ActorScript_obj{
	public:
		typedef ::com::stencyl::behavior::ActorScript_obj super;
		typedef Design_49_49_obj OBJ_;
		Design_49_49_obj();
		Void __construct(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);

	public:
		static hx::ObjectPtr< Design_49_49_obj > __new(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);
		...
		::String __ToString() const { return HX_CSTRING("Design_49_49"); }
...
#endif /* INCLUDED_scripts_Design_49_49 */ 
