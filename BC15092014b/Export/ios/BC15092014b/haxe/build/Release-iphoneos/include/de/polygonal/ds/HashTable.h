...
class HXCPP_CLASS_ATTRIBUTES  HashTable_obj : public hx::Object{
	...
	public:
		static hx::ObjectPtr< HashTable_obj > __new(int slotCount,hx::Null< int >  __o_capacity,hx::Null< bool >  __o_isResizable,hx::Null< int >  __o_maxSize);
		...
		inline operator ::de::polygonal::ds::Map_obj *()
			{ return new ::de::polygonal::ds::Map_delegate_< HashTable_obj >(this); }
		inline operator ::de::polygonal::ds::Collection_obj *()
			{ return new ::de::polygonal::ds::Collection_delegate_< HashTable_obj >(this); }
		inline operator ::de::polygonal::ds::Hashable_obj *()
			{ return new ::de::polygonal::ds::Hashable_delegate_< HashTable_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("HashTable"); }

		virtual int __key( ::de::polygonal::ds::Hashable x);
		Dynamic __key_dyn();
		...
		virtual int getAll( Dynamic key,Dynamic values);
		Dynamic getAll_dyn();
		...
		virtual bool setIfAbsent( Dynamic key,Dynamic val);
		Dynamic setIfAbsent_dyn();

		virtual Dynamic getFront( Dynamic key);
		...
		Array< int > _tmpArr;
		::de::polygonal::ds::HashTableValIterator _iterator;
		bool _isResizable;
		int _sizeLevel;
		int _free;
		Array< int > _next;
