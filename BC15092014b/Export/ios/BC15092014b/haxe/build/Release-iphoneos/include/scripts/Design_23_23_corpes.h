...
#define INCLUDED_scripts_Design_23_23_corpes
...
HX_DECLARE_CLASS1(scripts,Design_23_23_corpes)
namespace scripts{


class HXCPP_CLASS_ATTRIBUTES  Design_23_23_corpes_obj : public ::com::stencyl::behavior::ActorScript_obj{
	public:
		typedef ::com::stencyl::behavior::ActorScript_obj super;
		typedef Design_23_23_corpes_obj OBJ_;
		Design_23_23_corpes_obj();
		Void __construct(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);

	public:
		static hx::ObjectPtr< Design_23_23_corpes_obj > __new(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);
		...
		::String __ToString() const { return HX_CSTRING("Design_23_23_corpes"); }
...
#endif /* INCLUDED_scripts_Design_23_23_corpes */ 
