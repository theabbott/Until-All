...
#define INCLUDED_scripts_Design_6_6_Metronome
...
HX_DECLARE_CLASS1(scripts,Design_6_6_Metronome)
namespace scripts{


class HXCPP_CLASS_ATTRIBUTES  Design_6_6_Metronome_obj : public ::com::stencyl::behavior::SceneScript_obj{
	public:
		typedef ::com::stencyl::behavior::SceneScript_obj super;
		typedef Design_6_6_Metronome_obj OBJ_;
		Design_6_6_Metronome_obj();
		Void __construct(int dummy,::com::stencyl::Engine engine);

	public:
		static hx::ObjectPtr< Design_6_6_Metronome_obj > __new(int dummy,::com::stencyl::Engine engine);
		...
		::String __ToString() const { return HX_CSTRING("Design_6_6_Metronome"); }
...
#endif /* INCLUDED_scripts_Design_6_6_Metronome */ 
