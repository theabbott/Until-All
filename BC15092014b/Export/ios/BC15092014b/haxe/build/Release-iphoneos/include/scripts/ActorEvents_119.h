...
#define INCLUDED_scripts_ActorEvents_119
...
HX_DECLARE_CLASS1(scripts,ActorEvents_119)
namespace scripts{


class HXCPP_CLASS_ATTRIBUTES  ActorEvents_119_obj : public ::com::stencyl::behavior::ActorScript_obj{
	public:
		typedef ::com::stencyl::behavior::ActorScript_obj super;
		typedef ActorEvents_119_obj OBJ_;
		ActorEvents_119_obj();
		Void __construct(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);

	public:
		static hx::ObjectPtr< ActorEvents_119_obj > __new(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);
		...
		::String __ToString() const { return HX_CSTRING("ActorEvents_119"); }
...
#endif /* INCLUDED_scripts_ActorEvents_119 */ 
