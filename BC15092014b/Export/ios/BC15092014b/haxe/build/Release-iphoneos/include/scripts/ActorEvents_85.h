...
#define INCLUDED_scripts_ActorEvents_85
...
HX_DECLARE_CLASS1(scripts,ActorEvents_85)
namespace scripts{


class HXCPP_CLASS_ATTRIBUTES  ActorEvents_85_obj : public ::com::stencyl::behavior::ActorScript_obj{
	public:
		typedef ::com::stencyl::behavior::ActorScript_obj super;
		typedef ActorEvents_85_obj OBJ_;
		ActorEvents_85_obj();
		Void __construct(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);

	public:
		static hx::ObjectPtr< ActorEvents_85_obj > __new(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);
		...
		::String __ToString() const { return HX_CSTRING("ActorEvents_85"); }
...
#endif /* INCLUDED_scripts_ActorEvents_85 */ 
