...
#define INCLUDED_scripts_Design_21_21_Particles
...
HX_DECLARE_CLASS1(scripts,Design_21_21_Particles)
namespace scripts{


class HXCPP_CLASS_ATTRIBUTES  Design_21_21_Particles_obj : public ::com::stencyl::behavior::ActorScript_obj{
	public:
		typedef ::com::stencyl::behavior::ActorScript_obj super;
		typedef Design_21_21_Particles_obj OBJ_;
		Design_21_21_Particles_obj();
		Void __construct(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);

	public:
		static hx::ObjectPtr< Design_21_21_Particles_obj > __new(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);
		...
		::String __ToString() const { return HX_CSTRING("Design_21_21_Particles"); }
...
#endif /* INCLUDED_scripts_Design_21_21_Particles */ 
