...
#define INCLUDED_scripts_ActorEvents_97
...
HX_DECLARE_CLASS1(scripts,ActorEvents_97)
namespace scripts{


class HXCPP_CLASS_ATTRIBUTES  ActorEvents_97_obj : public ::com::stencyl::behavior::ActorScript_obj{
	public:
		typedef ::com::stencyl::behavior::ActorScript_obj super;
		typedef ActorEvents_97_obj OBJ_;
		ActorEvents_97_obj();
		Void __construct(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);

	public:
		static hx::ObjectPtr< ActorEvents_97_obj > __new(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);
		...
		::String __ToString() const { return HX_CSTRING("ActorEvents_97"); }
...
#endif /* INCLUDED_scripts_ActorEvents_97 */ 
