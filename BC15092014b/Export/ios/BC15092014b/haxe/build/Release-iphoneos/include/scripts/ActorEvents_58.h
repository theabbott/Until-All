...
#define INCLUDED_scripts_ActorEvents_58
...
HX_DECLARE_CLASS1(scripts,ActorEvents_58)
namespace scripts{


class HXCPP_CLASS_ATTRIBUTES  ActorEvents_58_obj : public ::com::stencyl::behavior::ActorScript_obj{
	public:
		typedef ::com::stencyl::behavior::ActorScript_obj super;
		typedef ActorEvents_58_obj OBJ_;
		ActorEvents_58_obj();
		Void __construct(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);

	public:
		static hx::ObjectPtr< ActorEvents_58_obj > __new(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine);
		...
		::String __ToString() const { return HX_CSTRING("ActorEvents_58"); }
...
#endif /* INCLUDED_scripts_ActorEvents_58 */ 
