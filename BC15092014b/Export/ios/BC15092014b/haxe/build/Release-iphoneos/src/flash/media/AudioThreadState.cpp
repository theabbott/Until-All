...
{
HX_STACK_PUSH("AudioThreadState::new","flash/media/SoundChannel.hx",322);
{
	HX_STACK_LINE(324)
...
{
		HX_STACK_PUSH("AudioThreadState::updateComplete","flash/media/SoundChannel.hx",371);
		HX_STACK_THIS(this);
		HX_STACK_LINE(373)
		this->mutex->acquire();
		HX_STACK_LINE(375)
...
{
		HX_STACK_PUSH("AudioThreadState::remove","flash/media/SoundChannel.hx",342);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("AudioThreadState::add","flash/media/SoundChannel.hx",330);
		HX_STACK_THIS(this);
		HX_STACK_ARG(channel,"channel");
		HX_STACK_LINE(330)
		if ((!(::Lambda_obj::has(this->channelList,channel)))){
