...
{
HX_STACK_PUSH("List::new","List.hx",40);
{
	HX_STACK_LINE(40)
	this->length = (int)0;
}
...
Dynamic List_obj::iterator( ){
	HX_STACK_PUSH("List::iterator","List.hx",161);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static Dynamic Block( ::List_obj *__this){
			HX_STACK_PUSH("*::closure","List.hx",179);
			{
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_1","List.hx",181);
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_2","List.hx",184);
					HX_STACK_THIS(__this.mPtr);
					{
						HX_STACK_LINE(186)
...
bool List_obj::remove( Dynamic v){
	HX_STACK_PUSH("List::remove","List.hx",138);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(139)
...
Void List_obj::clear( ){
{
		HX_STACK_PUSH("List::clear","List.hx",124);
		HX_STACK_THIS(this);
		HX_STACK_LINE(125)
		this->h = null();
		HX_STACK_LINE(126)
...
bool List_obj::isEmpty( ){
	HX_STACK_PUSH("List::isEmpty","List.hx",114);
	HX_STACK_THIS(this);
	HX_STACK_LINE(114)
	return (this->h == null());
}
...
Dynamic List_obj::pop( ){
	HX_STACK_PUSH("List::pop","List.hx",100);
	HX_STACK_THIS(this);
	HX_STACK_LINE(101)
	if (((this->h == null()))){
		HX_STACK_LINE(102)
...
{
		HX_STACK_PUSH("List::push","List.hx",64);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("List::add","List.hx",49);
		HX_STACK_THIS(this);
		HX_STACK_ARG(item,"item");
		HX_STACK_LINE(50)
