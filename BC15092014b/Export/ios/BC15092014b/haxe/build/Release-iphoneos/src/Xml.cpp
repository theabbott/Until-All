...
::Xml Xml_obj::firstElement( ){
	HX_STACK_PUSH("Xml::firstElement","Xml.hx",311);
	HX_STACK_THIS(this);
	HX_STACK_LINE(312)
	if (((this->_children == null()))){
		HX_STACK_LINE(313)
...
Dynamic Xml_obj::elementsNamed( ::String name){
	HX_STACK_PUSH("Xml::elementsNamed","Xml.hx",271);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &children,Array< ::String > &name1){
			HX_STACK_PUSH("*::closure","Xml.hx",275);
			{
				...
				bool run(){
					HX_STACK_PUSH("*::_Function_2_1","Xml.hx",277);
				...
				::Xml run(){
					HX_STACK_PUSH("*::_Function_2_2","Xml.hx",289);
					HX_STACK_THIS(__this.mPtr);
					{
						HX_STACK_LINE(290)
						int k = __this->__Field(HX_CSTRING("cur"),true);		HX_STACK_VAR(k,"k");
...
Dynamic Xml_obj::elements( ){
	HX_STACK_PUSH("Xml::elements","Xml.hx",238);
	HX_STACK_THIS(this);
	HX_STACK_LINE(239)
	if (((this->_children == null()))){
		HX_STACK_LINE(240)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &children){
			HX_STACK_PUSH("*::closure","Xml.hx",242);
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("cur") , (int)0,false);
				...
				bool run(){
					HX_STACK_PUSH("*::_Function_2_1","Xml.hx",244);
					HX_STACK_THIS(__this.mPtr);
					{
						HX_STACK_LINE(245)
						int k = __this->__Field(HX_CSTRING("cur"),true);		HX_STACK_VAR(k,"k");
				...
				::Xml run(){
					HX_STACK_PUSH("*::_Function_2_2","Xml.hx",255);
					HX_STACK_THIS(__this.mPtr);
					{
						HX_STACK_LINE(256)
						int k = __this->__Field(HX_CSTRING("cur"),true);		HX_STACK_VAR(k,"k");
...
bool Xml_obj::exists( ::String att){
	HX_STACK_PUSH("Xml::exists","Xml.hx",219);
	HX_STACK_THIS(this);
...
::String Xml_obj::get( ::String att){
	HX_STACK_PUSH("Xml::get","Xml.hx",197);
	HX_STACK_THIS(this);
	HX_STACK_ARG(att,"att");
	HX_STACK_LINE(198)
	if (((this->nodeType != ::Xml_obj::Element))){
...
::String Xml_obj::get_nodeName( ){
	HX_STACK_PUSH("Xml::get_nodeName","Xml.hx",168);
	HX_STACK_THIS(this);
	HX_STACK_LINE(169)
	if (((this->nodeType != ::Xml_obj::Element))){
		HX_STACK_LINE(170)
