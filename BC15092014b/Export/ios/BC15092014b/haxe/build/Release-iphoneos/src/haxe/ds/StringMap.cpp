...
{
HX_STACK_PUSH("StringMap::new","haxe/ds/StringMap.hx",27);
{
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_PUSH("*::closure","haxe/ds/StringMap.hx",28);
			{
...
::String StringMap_obj::toString( ){
	HX_STACK_PUSH("StringMap::toString","haxe/ds/StringMap.hx",74);
	HX_STACK_THIS(this);
	HX_STACK_LINE(75)
...
Dynamic StringMap_obj::iterator( ){
	HX_STACK_PUSH("StringMap::iterator","haxe/ds/StringMap.hx",59);
	HX_STACK_THIS(this);
	HX_STACK_LINE(60)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &me,Dynamic &it){
			HX_STACK_PUSH("*::closure","haxe/ds/StringMap.hx",64);
			{
				hx::Anon __result = hx::Anon_obj::Create();

				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_2_1,Dynamic,it)
				bool run(){
					HX_STACK_PUSH("*::_Function_2_1","haxe/ds/StringMap.hx",65);
					{
						HX_STACK_LINE(65)
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_2","haxe/ds/StringMap.hx",66);
					{
						HX_STACK_LINE(66)
...
Dynamic StringMap_obj::keys( ){
	HX_STACK_PUSH("StringMap::keys","haxe/ds/StringMap.hx",50);
	HX_STACK_THIS(this);
	HX_STACK_LINE(51)
	Array< ::String > a = Array_obj< ::String >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(52)
...
bool StringMap_obj::remove( ::String key){
	HX_STACK_PUSH("StringMap::remove","haxe/ds/StringMap.hx",43);
	HX_STACK_THIS(this);
...
bool StringMap_obj::exists( ::String key){
	HX_STACK_PUSH("StringMap::exists","haxe/ds/StringMap.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(39)
...
Dynamic StringMap_obj::get( ::String key){
	HX_STACK_PUSH("StringMap::get","haxe/ds/StringMap.hx",35);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(35)
...
{
		HX_STACK_PUSH("StringMap::set","haxe/ds/StringMap.hx",31);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
