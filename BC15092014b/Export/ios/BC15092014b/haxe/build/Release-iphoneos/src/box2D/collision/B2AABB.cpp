...
{
HX_STACK_PUSH("B2AABB::new","box2D/collision/B2AABB.hx",215);
{
	HX_STACK_LINE(217)
...
{
		HX_STACK_PUSH("B2AABB::combine","box2D/collision/B2AABB.hx",208);
		HX_STACK_THIS(this);
...
bool B2AABB_obj::testOverlap( ::box2D::collision::B2AABB other){
	HX_STACK_PUSH("B2AABB::testOverlap","box2D/collision/B2AABB.hx",183);
	HX_STACK_THIS(this);
...
bool B2AABB_obj::rayCast( ::box2D::collision::B2RayCastOutput output,::box2D::collision::B2RayCastInput input){
	HX_STACK_PUSH("B2AABB::rayCast","box2D/collision/B2AABB.hx",75);
	HX_STACK_THIS(this);
	HX_STACK_ARG(output,"output");
	HX_STACK_ARG(input,"input");
	HX_STACK_LINE(76)
	Float tmin = -(1.7976931348623158e+308);		HX_STACK_VAR(tmin,"tmin");
	HX_STACK_LINE(77)
...
bool B2AABB_obj::contains( ::box2D::collision::B2AABB aabb){
	HX_STACK_PUSH("B2AABB::contains","box2D/collision/B2AABB.hx",61);
	HX_STACK_THIS(this);
...
::box2D::common::math::B2Vec2 B2AABB_obj::getExtents( ){
	HX_STACK_PUSH("B2AABB::getExtents","box2D/collision/B2AABB.hx",52);
	HX_STACK_THIS(this);
	HX_STACK_LINE(52)
...
::box2D::common::math::B2Vec2 B2AABB_obj::getCenter( ){
	HX_STACK_PUSH("B2AABB::getCenter","box2D/collision/B2AABB.hx",45);
	HX_STACK_THIS(this);
	HX_STACK_LINE(45)
...
bool B2AABB_obj::isValid( ){
	HX_STACK_PUSH("B2AABB::isValid","box2D/collision/B2AABB.hx",34);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
