...
{
HX_STACK_PUSH("B2WeldJoint::new","box2D/dynamics/joints/B2WeldJoint.hx",73);
{
	HX_STACK_LINE(74)
...
bool B2WeldJoint_obj::solvePositionConstraints( Float baumgarte){
	HX_STACK_PUSH("B2WeldJoint::solvePositionConstraints","box2D/dynamics/joints/B2WeldJoint.hx",221);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("B2WeldJoint::solveVelocityConstraints","box2D/dynamics/joints/B2WeldJoint.hx",161);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("B2WeldJoint::initVelocityConstraints","box2D/dynamics/joints/B2WeldJoint.hx",90);
		HX_STACK_THIS(this);
		HX_STACK_ARG(step,"step");
		HX_STACK_LINE(91)
		::box2D::common::math::B2Mat22 tMat;		HX_STACK_VAR(tMat,"tMat");
...
Float B2WeldJoint_obj::getReactionTorque( Float inv_dt){
	HX_STACK_PUSH("B2WeldJoint::getReactionTorque","box2D/dynamics/joints/B2WeldJoint.hx",66);
	HX_STACK_THIS(this);
...
::box2D::common::math::B2Vec2 B2WeldJoint_obj::getReactionForce( Float inv_dt){
	HX_STACK_PUSH("B2WeldJoint::getReactionForce","box2D/dynamics/joints/B2WeldJoint.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inv_dt,"inv_dt");
	HX_STACK_LINE(60)
...
::box2D::common::math::B2Vec2 B2WeldJoint_obj::getAnchorB( ){
	HX_STACK_PUSH("B2WeldJoint::getAnchorB","box2D/dynamics/joints/B2WeldJoint.hx",54);
	HX_STACK_THIS(this);
	HX_STACK_LINE(54)
...
::box2D::common::math::B2Vec2 B2WeldJoint_obj::getAnchorA( ){
	HX_STACK_PUSH("B2WeldJoint::getAnchorA","box2D/dynamics/joints/B2WeldJoint.hx",50);
	HX_STACK_THIS(this);
	HX_STACK_LINE(50)
