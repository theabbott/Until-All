...
int B2Collision_obj::clipSegmentToLine( Array< ::Dynamic > vOut,Array< ::Dynamic > vIn,::box2D::common::math::B2Vec2 normal,Float offset){
	HX_STACK_PUSH("B2Collision::clipSegmentToLine","box2D/collision/B2Collision.hx",41);
	...
	if (((distance0 <= 0.0))){
		HX_STACK_LINE(57)
		vOut->__get((numOut)++).StaticCast< ::box2D::collision::ClipVertex >()->set(vIn->__get((int)0).StaticCast< ::box2D::collision::ClipVertex >());
	}
	HX_STACK_LINE(58)
	if (((distance1 <= 0.0))){
		HX_STACK_LINE(58)
		vOut->__get((numOut)++).StaticCast< ::box2D::collision::ClipVertex >()->set(vIn->__get((int)1).StaticCast< ::box2D::collision::ClipVertex >());
	}
	HX_STACK_LINE(61)
...
Float B2Collision_obj::edgeSeparation( ::box2D::collision::shapes::B2PolygonShape poly1,::box2D::common::math::B2Transform xf1,int edge1,::box2D::collision::shapes::B2PolygonShape poly2,::box2D::common::math::B2Transform xf2){
	HX_STACK_PUSH("B2Collision::edgeSeparation","box2D/collision/B2Collision.hx",93);
...
Float B2Collision_obj::findMaxSeparation( Array< int > edgeIndex,::box2D::collision::shapes::B2PolygonShape poly1,::box2D::common::math::B2Transform xf1,::box2D::collision::shapes::B2PolygonShape poly2,::box2D::common::math::B2Transform xf2){
	HX_STACK_PUSH("B2Collision::findMaxSeparation","box2D/collision/B2Collision.hx",159);
	...
	HX_STACK_LINE(183)
	Float maxDot = -(1.7976931348623158e+308);		HX_STACK_VAR(maxDot,"maxDot");
	HX_STACK_LINE(184)
	{
		HX_STACK_LINE(184)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
	...
	HX_STACK_LINE(200)
	int prevEdge = (  ((((edge - (int)1) >= (int)0))) ? int((edge - (int)1)) : int((count1 - (int)1)) );		HX_STACK_VAR(prevEdge,"prevEdge");
	HX_STACK_LINE(201)
	Float sPrev = ::box2D::collision::B2Collision_obj::edgeSeparation(poly1,xf1,prevEdge,poly2,xf2);		HX_STACK_VAR(sPrev,"sPrev");
	HX_STACK_LINE(204)
	int nextEdge = (  ((((edge + (int)1) < count1))) ? int((edge + (int)1)) : int((int)0) );		HX_STACK_VAR(nextEdge,"nextEdge");
	HX_STACK_LINE(205)
...
{
		HX_STACK_PUSH("B2Collision::findIncidentEdge","box2D/collision/B2Collision.hx",262);
		HX_STACK_ARG(c,"c");
		HX_STACK_ARG(poly1,"poly1");
		HX_STACK_ARG(xf1,"xf1");
		HX_STACK_ARG(edge1,"edge1");
		...
		HX_STACK_LINE(304)
		int i2 = (  ((((i1 + (int)1) < count2))) ? int((i1 + (int)1)) : int((int)0) );		HX_STACK_VAR(i2,"i2");
		HX_STACK_LINE(306)
...
Array< ::Dynamic > B2Collision_obj::makeClipPointVector( ){
	HX_STACK_PUSH("B2Collision::makeClipPointVector","box2D/collision/B2Collision.hx",331);
	HX_STACK_LINE(332)
...
{
		HX_STACK_PUSH("B2Collision::collidePolygons","box2D/collision/B2Collision.hx",360);
		...
		if ((((edge1 + (int)1) < count1))){
			HX_STACK_LINE(419)
			local_v12 = vertices1->__get(::Std_obj::_int((edge1 + (int)1))).StaticCast< ::box2D::common::math::B2Vec2 >();
		}
		else{
			HX_STACK_LINE(421)
		...
		HX_STACK_LINE(482)
		{
			...
			HX_STACK_LINE(482)
			_this->x = localNormal->x;
			HX_STACK_LINE(482)
			_this->y = localNormal->y;
		}
		HX_STACK_LINE(483)
		{
			HX_STACK_LINE(483)
			...
			HX_STACK_LINE(483)
			_this->x = planePoint->x;
			HX_STACK_LINE(483)
			_this->y = planePoint->y;
		}
		HX_STACK_LINE(485)
...
{
		HX_STACK_PUSH("B2Collision::collideCircles","box2D/collision/B2Collision.hx",514);
		HX_STACK_ARG(manifold,"manifold");
		...
		HX_STACK_LINE(539)
		{
			HX_STACK_LINE(539)
			::box2D::common::math::B2Vec2 _this = manifold->m_localPoint;		HX_STACK_VAR(_this,"_this");
			::box2D::common::math::B2Vec2 v = circle1->m_p;		HX_STACK_VAR(v,"v");
			HX_STACK_LINE(539)
			_this->x = v->x;
			HX_STACK_LINE(539)
			_this->y = v->y;
		...
		HX_STACK_LINE(542)
		{
			...
			::box2D::common::math::B2Vec2 v = circle2->m_p;		HX_STACK_VAR(v,"v");
			HX_STACK_LINE(542)
			_this->x = v->x;
			HX_STACK_LINE(542)
			_this->y = v->y;
...
{
		HX_STACK_PUSH("B2Collision::collidePolygonAndCircle","box2D/collision/B2Collision.hx",552);
		HX_STACK_ARG(manifold,"manifold");
		...
		HX_STACK_LINE(582)
		Float separation = -(1.7976931348623158e+308);		HX_STACK_VAR(separation,"separation");
		HX_STACK_LINE(583)
		...
		HX_STACK_LINE(611)
		int vertIndex2 = (  ((((vertIndex1 + (int)1) < vertexCount))) ? int((vertIndex1 + (int)1)) : int((int)0) );		HX_STACK_VAR(vertIndex2,"vertIndex2");
		HX_STACK_LINE(612)
		...
		if (((separation < 2.2250738585072014e-308))){
			...
			HX_STACK_LINE(620)
			{
				HX_STACK_LINE(620)
				::box2D::common::math::B2Vec2 _this = manifold->m_localPlaneNormal;		HX_STACK_VAR(_this,"_this");
				::box2D::common::math::B2Vec2 v = normals->__get(normalIndex).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(v,"v");
				HX_STACK_LINE(620)
				_this->x = v->x;
				HX_STACK_LINE(620)
				_this->y = v->y;
			...
			HX_STACK_LINE(623)
			{
				HX_STACK_LINE(623)
				::box2D::common::math::B2Vec2 _this = manifold->m_points->__get((int)0).StaticCast< ::box2D::collision::B2ManifoldPoint >()->m_localPoint;		HX_STACK_VAR(_this,"_this");
				::box2D::common::math::B2Vec2 v = circle->m_p;		HX_STACK_VAR(v,"v");
				HX_STACK_LINE(623)
				_this->x = v->x;
				HX_STACK_LINE(623)
				_this->y = v->y;
...
bool B2Collision_obj::testOverlap( ::box2D::collision::B2AABB a,::box2D::collision::B2AABB b){
	HX_STACK_PUSH("B2Collision::testOverlap","box2D/collision/B2Collision.hx",679);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(680)
...
void B2Collision_obj::__Visit(HX_VISIT_PARAMS)
{
}
