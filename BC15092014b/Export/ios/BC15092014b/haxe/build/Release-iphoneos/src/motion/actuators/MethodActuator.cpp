...
{
		HX_STACK_PUSH("MethodActuator::update","motion/actuators/MethodActuator.hx",109);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("MethodActuator::initialize","motion/actuators/MethodActuator.hx",81);
		HX_STACK_THIS(this);
		HX_STACK_LINE(83)
...
bool sendEvent = __o_sendEvent.Default(true);
	HX_STACK_PUSH("MethodActuator::complete","motion/actuators/MethodActuator.hx",58);
	HX_STACK_THIS(this);
