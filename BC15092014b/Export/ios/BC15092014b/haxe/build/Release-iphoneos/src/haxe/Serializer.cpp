...
{
HX_STACK_PUSH("Serializer::new","haxe/Serializer.hx",99);
{
	HX_STACK_LINE(100)
...
{
		HX_STACK_PUSH("Serializer::serialize","haxe/Serializer.hx",223);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(224)
...
{
		HX_STACK_PUSH("Serializer::serializeFields","haxe/Serializer.hx",205);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(206)
		{
...
bool Serializer_obj::serializeRef( Dynamic v){
	HX_STACK_PUSH("Serializer::serializeRef","haxe/Serializer.hx",168);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(172)
	{
...
{
		HX_STACK_PUSH("Serializer::serializeString","haxe/Serializer.hx",149);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(150)
...
::String Serializer_obj::toString( ){
	HX_STACK_PUSH("Serializer::toString","haxe/Serializer.hx",114);
	HX_STACK_THIS(this);
	HX_STACK_LINE(114)
...
::String Serializer_obj::run( Dynamic v){
	HX_STACK_PUSH("Serializer::run","haxe/Serializer.hx",520);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(521)
