...
::String Bytes_obj::toString( ){
	HX_STACK_PUSH("Bytes::toString","haxe/io/Bytes.hx",211);
	HX_STACK_THIS(this);
	HX_STACK_LINE(211)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_PUSH("Bytes::sub","haxe/io/Bytes.hx",99);
	HX_STACK_THIS(this);
	HX_STACK_ARG(pos,"pos");
	HX_STACK_ARG(len,"len");
	HX_STACK_LINE(101)
...
{
		HX_STACK_PUSH("Bytes::blit","haxe/io/Bytes.hx",68);
		HX_STACK_THIS(this);
		HX_STACK_ARG(pos,"pos");
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_PUSH("Bytes::alloc","haxe/io/Bytes.hx",250);
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_PUSH("Bytes::ofData","haxe/io/Bytes.hx",324);
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(324)
