...
::String type = __o_type.Default(HX_CSTRING("DirectRenderer"));
{
	...
	HX_STACK_LINE(15)
	super::__construct(::openfl::display::DirectRenderer_obj::nme_direct_renderer_create(),type);
	...
	Void run(Dynamic _){
		...
		{
			HX_STACK_LINE(17)
			::openfl::display::DirectRenderer_obj::nme_direct_renderer_set(_g->__get((int)0).StaticCast< ::openfl::display::DirectRenderer >()->__handle,_g->__get((int)0).StaticCast< ::openfl::display::DirectRenderer >()->__onRender_dyn());
		}
		return null();
	}
	...
	Void run(Dynamic _){
		...
		{
			HX_STACK_LINE(18)
			::openfl::display::DirectRenderer_obj::nme_direct_renderer_set(_g->__get((int)0).StaticCast< ::openfl::display::DirectRenderer >()->__handle,null());
		}
		return null();
	}
	HX_END_LOCAL_FUNC1((void))
...
{
	nme_direct_renderer_create= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_direct_renderer_create"),(int)0);
	nme_direct_renderer_set= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_direct_renderer_set"),(int)2);
}
