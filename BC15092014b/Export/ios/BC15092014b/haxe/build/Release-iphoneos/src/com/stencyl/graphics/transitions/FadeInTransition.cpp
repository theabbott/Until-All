...
{
HX_STACK_PUSH("FadeInTransition::new","com/stencyl/graphics/transitions/FadeInTransition.hx",18);
...
{  hx::ObjectPtr< FadeInTransition_obj > result = new FadeInTransition_obj();
...
{
		HX_STACK_PUSH("FadeInTransition::cleanup","com/stencyl/graphics/transitions/FadeInTransition.hx",40);
		HX_STACK_THIS(this);
		HX_STACK_LINE(40)
		if (((this->rect != null()))){
			HX_STACK_LINE(43)
...
{
		HX_STACK_PUSH("FadeInTransition::start","com/stencyl/graphics/transitions/FadeInTransition.hx",26);
		HX_STACK_THIS(this);
		HX_STACK_LINE(27)
		this->active = true;
		HX_STACK_LINE(29)
		...
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_PUSH("*::closure","com/stencyl/graphics/transitions/FadeInTransition.hx",36);
				{
...
Dynamic FadeInTransition_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic FadeInTransition_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
Class FadeInTransition_obj::__mClass;

void FadeInTransition_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.stencyl.graphics.transitions.FadeInTransition"), hx::TCanCast< FadeInTransition_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void FadeInTransition_obj::__boot()
{
}
