...
{
HX_STACK_PUSH("B2PolygonShape::new","box2D/collision/shapes/B2PolygonShape.hx",723);
{
	HX_STACK_LINE(725)
	super::__construct();
	HX_STACK_LINE(728)
	...
	HX_STACK_LINE(732)
	this->m_normals = Array_obj< ::Dynamic >::__new();
}
;
	return null();
}
...
{
		HX_STACK_PUSH("B2PolygonShape::reserve","box2D/collision/shapes/B2PolygonShape.hx",736);
		HX_STACK_THIS(this);
...
bool B2PolygonShape_obj::validate( ){
	HX_STACK_PUSH("B2PolygonShape::validate","box2D/collision/shapes/B2PolygonShape.hx",682);
	HX_STACK_THIS(this);
	HX_STACK_LINE(682)
	return false;
}
...
::box2D::common::math::B2Vec2 B2PolygonShape_obj::getSupportVertex( ::box2D::common::math::B2Vec2 d){
	HX_STACK_PUSH("B2PolygonShape::getSupportVertex","box2D/collision/shapes/B2PolygonShape.hx",665);
	HX_STACK_THIS(this);
	HX_STACK_ARG(d,"d");
	HX_STACK_LINE(666)
...
int B2PolygonShape_obj::getSupport( ::box2D::common::math::B2Vec2 d){
	HX_STACK_PUSH("B2PolygonShape::getSupport","box2D/collision/shapes/B2PolygonShape.hx",649);
	HX_STACK_THIS(this);
	HX_STACK_ARG(d,"d");
	HX_STACK_LINE(650)
	int bestIndex = (int)0;		HX_STACK_VAR(bestIndex,"bestIndex");
...
Array< ::Dynamic > B2PolygonShape_obj::getNormals( ){
	HX_STACK_PUSH("B2PolygonShape::getNormals","box2D/collision/shapes/B2PolygonShape.hx",641);
	HX_STACK_THIS(this);
	HX_STACK_LINE(641)
...
Array< ::Dynamic > B2PolygonShape_obj::getVertices( ){
	HX_STACK_PUSH("B2PolygonShape::getVertices","box2D/collision/shapes/B2PolygonShape.hx",633);
	HX_STACK_THIS(this);
	HX_STACK_LINE(633)
...
int B2PolygonShape_obj::getVertexCount( ){
	HX_STACK_PUSH("B2PolygonShape::getVertexCount","box2D/collision/shapes/B2PolygonShape.hx",626);
	HX_STACK_THIS(this);
	HX_STACK_LINE(626)
...
Float B2PolygonShape_obj::computeSubmergedArea( ::box2D::common::math::B2Vec2 normal,Float offset,::box2D::common::math::B2Transform xf,::box2D::common::math::B2Vec2 c){
	HX_STACK_PUSH("B2PolygonShape::computeSubmergedArea","box2D/collision/shapes/B2PolygonShape.hx",516);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(518)
	::box2D::common::math::B2Vec2 normalL = ::box2D::common::math::B2Math_obj::mulTMV(xf->R,normal,true);		HX_STACK_VAR(normalL,"normalL");
	HX_STACK_LINE(519)
	Float offsetL = (offset - ::box2D::common::math::B2Math_obj::dot(normal,xf->position));		HX_STACK_VAR(offsetL,"offsetL");
	HX_STACK_LINE(521)
	...
	HX_STACK_LINE(528)
	{
		...
		while(((_g1 < _g))){
			...
			HX_STACK_LINE(530)
			depths[i1] = (::box2D::common::math::B2Math_obj::dot(normalL,this->m_vertices->__get(i1).StaticCast< ::box2D::common::math::B2Vec2 >()) - offsetL);
			HX_STACK_LINE(531)
	...
	switch( (int)(diveCount)){
		case (int)0: {
			...
			if ((lastSubmerged)){
				...
				{
					HX_STACK_LINE(561)
					::box2D::common::math::B2Vec2 v = ::box2D::common::math::B2Math_obj::mulX(xf,md->center,null());		HX_STACK_VAR(v,"v");
					HX_STACK_LINE(561)
					c->x = v->x;
					HX_STACK_LINE(561)
					c->y = v->y;
	...
	{
		HX_STACK_LINE(618)
		::box2D::common::math::B2Vec2 v = ::box2D::common::math::B2Math_obj::mulX(xf,center,null());		HX_STACK_VAR(v,"v");
		HX_STACK_LINE(618)
		c->x = v->x;
		HX_STACK_LINE(618)
		c->y = v->y;
...
{
		HX_STACK_PUSH("B2PolygonShape::computeMass","box2D/collision/shapes/B2PolygonShape.hx",387);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(444)
		Float k_inv3 = (Float(1.0) / Float(3.0));		HX_STACK_VAR(k_inv3,"k_inv3");
		HX_STACK_LINE(446)
		{
			HX_STACK_LINE(446)
			int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
			...
			while(((_g1 < _g))){
				...
				HX_STACK_LINE(454)
				::box2D::common::math::B2Vec2 p3 = (  ((((i + (int)1) < this->m_vertexCount))) ? ::box2D::common::math::B2Vec2(this->m_vertices->__get(::Std_obj::_int((i + (int)1))).StaticCast< ::box2D::common::math::B2Vec2 >()) : ::box2D::common::math::B2Vec2(this->m_vertices->__get((int)0).StaticCast< ::box2D::common::math::B2Vec2 >()) );		HX_STACK_VAR(p3,"p3");
				HX_STACK_LINE(457)
...
{
		HX_STACK_PUSH("B2PolygonShape::computeAABB","box2D/collision/shapes/B2PolygonShape.hx",357);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(366)
		{
			...
			while(((_g1 < _g))){
				...
				HX_STACK_LINE(371)
				lowerX = (  (((lowerX < vX))) ? Float(lowerX) : Float(vX) );
				HX_STACK_LINE(372)
				lowerY = (  (((lowerY < vY))) ? Float(lowerY) : Float(vY) );
				HX_STACK_LINE(373)
				upperX = (  (((upperX > vX))) ? Float(upperX) : Float(vX) );
				HX_STACK_LINE(374)
				upperY = (  (((upperY > vY))) ? Float(upperY) : Float(vY) );
			}
		}
		HX_STACK_LINE(377)
...
bool B2PolygonShape_obj::rayCast( ::box2D::collision::B2RayCastOutput output,::box2D::collision::B2RayCastInput input,::box2D::common::math::B2Transform transform){
	HX_STACK_PUSH("B2PolygonShape::rayCast","box2D/collision/shapes/B2PolygonShape.hx",260);
	HX_STACK_THIS(this);
...
bool B2PolygonShape_obj::testPoint( ::box2D::common::math::B2Transform xf,::box2D::common::math::B2Vec2 p){
	HX_STACK_PUSH("B2PolygonShape::testPoint","box2D/collision/shapes/B2PolygonShape.hx",229);
	HX_STACK_THIS(this);
	HX_STACK_ARG(xf,"xf");
	HX_STACK_ARG(p,"p");
	HX_STACK_LINE(230)
...
{
		HX_STACK_PUSH("B2PolygonShape::setAsEdge","box2D/collision/shapes/B2PolygonShape.hx",202);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v1,"v1");
		HX_STACK_ARG(v2,"v2");
		HX_STACK_LINE(203)
		...
		{
			HX_STACK_LINE(205)
			::box2D::common::math::B2Vec2 _this = this->m_vertices->__get((int)0).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(205)
			_this->x = v1->x;
			HX_STACK_LINE(205)
			_this->y = v1->y;
		...
		{
			HX_STACK_LINE(206)
			::box2D::common::math::B2Vec2 _this = this->m_vertices->__get((int)1).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(206)
			_this->x = v2->x;
			HX_STACK_LINE(206)
			_this->y = v2->y;
		...
		HX_STACK_LINE(209)
		this->m_normals[(int)0] = ::box2D::common::math::B2Math_obj::crossVF(::box2D::common::math::B2Math_obj::subtractVV(v2,v1),1.0,null());
		HX_STACK_LINE(210)
...
Float angle = __o_angle.Default(0.0);
	HX_STACK_PUSH("B2PolygonShape::setAsOrientedBox","box2D/collision/shapes/B2PolygonShape.hx",166);
	HX_STACK_THIS(this);
	HX_STACK_ARG(hx,"hx");
	HX_STACK_ARG(hy,"hy");
	...
	HX_STACK_ARG(angle,"angle");
{
		...
		{
			HX_STACK_LINE(171)
			::box2D::common::math::B2Vec2 _this = this->m_vertices->__get((int)2).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(171)
			_this->x = hx;
			HX_STACK_LINE(171)
			_this->y = hy;
		...
		{
			HX_STACK_LINE(172)
			::box2D::common::math::B2Vec2 _this = this->m_vertices->__get((int)3).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(172)
			_this->x = -(hx);
			HX_STACK_LINE(172)
			_this->y = hy;
		...
		{
			HX_STACK_LINE(173)
			::box2D::common::math::B2Vec2 _this = this->m_normals->__get((int)0).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(173)
			_this->x = 0.0;
			HX_STACK_LINE(173)
			_this->y = -1.0;
		...
		{
			HX_STACK_LINE(174)
			::box2D::common::math::B2Vec2 _this = this->m_normals->__get((int)1).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(174)
			_this->x = 1.0;
			HX_STACK_LINE(174)
			_this->y = 0.0;
		...
		{
			HX_STACK_LINE(175)
			::box2D::common::math::B2Vec2 _this = this->m_normals->__get((int)2).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(175)
			_this->x = 0.0;
			HX_STACK_LINE(175)
			_this->y = 1.0;
		...
		{
			HX_STACK_LINE(176)
			::box2D::common::math::B2Vec2 _this = this->m_normals->__get((int)3).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(176)
			_this->x = -1.0;
			HX_STACK_LINE(176)
			_this->y = 0.0;
		...
		HX_STACK_LINE(184)
		{
			...
			while(((_g1 < _g))){
				...
				int i = (_g1)++;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(186)
				this->m_vertices[i] = ::box2D::common::math::B2Math_obj::mulX(xf,this->m_vertices->__get(i).StaticCast< ::box2D::common::math::B2Vec2 >(),null());
				HX_STACK_LINE(187)
				this->m_normals[i] = ::box2D::common::math::B2Math_obj::mulMV(xf->R,this->m_normals->__get(i).StaticCast< ::box2D::common::math::B2Vec2 >(),null());
			}
		}
	}
return null();
...
{
		HX_STACK_PUSH("B2PolygonShape::setAsBox","box2D/collision/shapes/B2PolygonShape.hx",136);
		HX_STACK_THIS(this);
		HX_STACK_ARG(hx,"hx");
		HX_STACK_ARG(hy,"hy");
		HX_STACK_LINE(137)
		...
		{
			HX_STACK_LINE(147)
			::box2D::common::math::B2Vec2 _this = this->m_centroid;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(147)
			_this->x = 0.0;
			HX_STACK_LINE(147)
			_this->y = 0.0;
...
Float vertexCount = __o_vertexCount.Default(0);
	HX_STACK_PUSH("B2PolygonShape::setAsVector","box2D/collision/shapes/B2PolygonShape.hx",91);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(vertexCount,"vertexCount");
{
		...
		HX_STACK_LINE(103)
		{
			...
			while(((_g1 < _g))){
				...
				{
					HX_STACK_LINE(105)
					::box2D::common::math::B2Vec2 _this = this->m_vertices->__get(i1).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
					::box2D::common::math::B2Vec2 v = vertices->__get(i1).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(v,"v");
					HX_STACK_LINE(105)
					_this->x = v->x;
					HX_STACK_LINE(105)
					_this->y = v->y;
		...
		HX_STACK_LINE(109)
		{
			...
			while(((_g1 < _g))){
				...
				HX_STACK_LINE(112)
				int i2 = (  ((((i1 + (int)1) < this->m_vertexCount))) ? int((i1 + (int)1)) : int((int)0) );		HX_STACK_VAR(i2,"i2");
				HX_STACK_LINE(113)
				::box2D::common::math::B2Vec2 edge = ::box2D::common::math::B2Math_obj::subtractVVPooled(this->m_vertices->__get(i2).StaticCast< ::box2D::common::math::B2Vec2 >(),this->m_vertices->__get(i11).StaticCast< ::box2D::common::math::B2Vec2 >());		HX_STACK_VAR(edge,"edge");
				HX_STACK_LINE(114)
				::box2D::common::B2Settings_obj::b2Assert((edge->lengthSquared() > 2.2250738585072014e-308));
				HX_STACK_LINE(115)
				{
					HX_STACK_LINE(115)
					::box2D::common::math::B2Vec2 _this = this->m_normals->__get(i1).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
					::box2D::common::math::B2Vec2 v = ::box2D::common::math::B2Math_obj::crossVF(edge,1.0,null());		HX_STACK_VAR(v,"v");
					HX_STACK_LINE(115)
					_this->x = v->x;
					HX_STACK_LINE(115)
					_this->y = v->y;
...
Float vertexCount = __o_vertexCount.Default(0);
	HX_STACK_PUSH("B2PolygonShape::setAsArray","box2D/collision/shapes/B2PolygonShape.hx",70);
	HX_STACK_THIS(this);
	HX_STACK_ARG(vertices,"vertices");
	HX_STACK_ARG(vertexCount,"vertexCount");
{
		...
		HX_STACK_LINE(72)
		{
			...
			HX_STACK_LINE(72)
			while(((_g < vertices->__Field(HX_CSTRING("length"),true)))){
				HX_STACK_LINE(72)
...
{
		HX_STACK_PUSH("B2PolygonShape::set","box2D/collision/shapes/B2PolygonShape.hx",49);
		HX_STACK_THIS(this);
		...
		if ((::Std_obj::is(other,hx::ClassOf< ::box2D::collision::shapes::B2PolygonShape >()))){
			HX_STACK_LINE(53)
			::box2D::collision::shapes::B2PolygonShape other2 = hx::TCast< box2D::collision::shapes::B2PolygonShape >::cast(other);		HX_STACK_VAR(other2,"other2");
			HX_STACK_LINE(54)
			{
				HX_STACK_LINE(54)
				::box2D::common::math::B2Vec2 _this = this->m_centroid;		HX_STACK_VAR(_this,"_this");
				::box2D::common::math::B2Vec2 v = other2->m_centroid;		HX_STACK_VAR(v,"v");
				HX_STACK_LINE(54)
				_this->x = v->x;
				HX_STACK_LINE(54)
				_this->y = v->y;
			...
			HX_STACK_LINE(57)
			{
				...
				while(((_g1 < _g))){
					...
					{
						HX_STACK_LINE(59)
						::box2D::common::math::B2Vec2 _this = this->m_vertices->__get(i).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
						::box2D::common::math::B2Vec2 v = other2->m_vertices->__get(i).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(v,"v");
						HX_STACK_LINE(59)
						_this->x = v->x;
						HX_STACK_LINE(59)
						_this->y = v->y;
					...
					{
						HX_STACK_LINE(60)
						::box2D::common::math::B2Vec2 _this = this->m_normals->__get(i).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(_this,"_this");
						::box2D::common::math::B2Vec2 v = other2->m_normals->__get(i).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(v,"v");
						HX_STACK_LINE(60)
						_this->x = v->x;
						HX_STACK_LINE(60)
						_this->y = v->y;
...
::box2D::collision::shapes::B2Shape B2PolygonShape_obj::copy( ){
	HX_STACK_PUSH("B2PolygonShape::copy","box2D/collision/shapes/B2PolygonShape.hx",42);
	HX_STACK_THIS(this);
	HX_STACK_LINE(43)
...
::box2D::collision::shapes::B2PolygonShape B2PolygonShape_obj::asArray( Dynamic vertices,Float vertexCount){
	HX_STACK_PUSH("B2PolygonShape::asArray","box2D/collision/shapes/B2PolygonShape.hx",80);
	HX_STACK_ARG(vertices,"vertices");
	HX_STACK_ARG(vertexCount,"vertexCount");
	HX_STACK_LINE(81)
...
::box2D::collision::shapes::B2PolygonShape B2PolygonShape_obj::asVector( Array< ::Dynamic > vertices,Float vertexCount){
	HX_STACK_PUSH("B2PolygonShape::asVector","box2D/collision/shapes/B2PolygonShape.hx",124);
	HX_STACK_ARG(vertices,"vertices");
	HX_STACK_ARG(vertexCount,"vertexCount");
	HX_STACK_LINE(125)
	::box2D::collision::shapes::B2PolygonShape polygonShape = ::box2D::collision::shapes::B2PolygonShape_obj::__new();		HX_STACK_VAR(polygonShape,"polygonShape");
...
::box2D::collision::shapes::B2PolygonShape B2PolygonShape_obj::asBox( Float hx,Float hy){
	HX_STACK_PUSH("B2PolygonShape::asBox","box2D/collision/shapes/B2PolygonShape.hx",151);
	HX_STACK_ARG(hx,"hx");
	HX_STACK_ARG(hy,"hy");
	HX_STACK_LINE(152)
	::box2D::collision::shapes::B2PolygonShape polygonShape = ::box2D::collision::shapes::B2PolygonShape_obj::__new();		HX_STACK_VAR(polygonShape,"polygonShape");
...
Float angle = __o_angle.Default(0.0);
	HX_STACK_PUSH("B2PolygonShape::asOrientedBox","box2D/collision/shapes/B2PolygonShape.hx",192);
	HX_STACK_ARG(hx,"hx");
	HX_STACK_ARG(hy,"hy");
	HX_STACK_ARG(center,"center");
	HX_STACK_ARG(angle,"angle");
...
::box2D::collision::shapes::B2PolygonShape B2PolygonShape_obj::asEdge( ::box2D::common::math::B2Vec2 v1,::box2D::common::math::B2Vec2 v2){
	HX_STACK_PUSH("B2PolygonShape::asEdge","box2D/collision/shapes/B2PolygonShape.hx",219);
	HX_STACK_ARG(v1,"v1");
	HX_STACK_ARG(v2,"v2");
	HX_STACK_LINE(220)
	::box2D::collision::shapes::B2PolygonShape polygonShape = ::box2D::collision::shapes::B2PolygonShape_obj::__new();		HX_STACK_VAR(polygonShape,"polygonShape");
...
::box2D::common::math::B2Vec2 B2PolygonShape_obj::computeCentroid( Array< ::Dynamic > vs,int count){
	HX_STACK_PUSH("B2PolygonShape::computeCentroid","box2D/collision/shapes/B2PolygonShape.hx",761);
	HX_STACK_ARG(vs,"vs");
	HX_STACK_ARG(count,"count");
	HX_STACK_LINE(765)
	...
	Float p1Y = 0.0;		HX_STACK_VAR(p1Y,"p1Y");
	HX_STACK_LINE(774)
	Float inv3 = (Float(1.0) / Float(3.0));		HX_STACK_VAR(inv3,"inv3");
	HX_STACK_LINE(776)
	{
		HX_STACK_LINE(776)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		...
		while(((_g < count))){
			...
			HX_STACK_LINE(784)
			::box2D::common::math::B2Vec2 p3 = (  ((((i + (int)1) < count))) ? ::box2D::common::math::B2Vec2(vs->__get(::Std_obj::_int((i + (int)1))).StaticCast< ::box2D::common::math::B2Vec2 >()) : ::box2D::common::math::B2Vec2(vs->__get((int)0).StaticCast< ::box2D::common::math::B2Vec2 >()) );		HX_STACK_VAR(p3,"p3");
			HX_STACK_LINE(787)
			Float e1X = (p2->x - p1X);		HX_STACK_VAR(e1X,"e1X");
			HX_STACK_LINE(788)
			Float e1Y = (p2->y - p1Y);		HX_STACK_VAR(e1Y,"e1Y");
...
{
		HX_STACK_PUSH("B2PolygonShape::computeOBB","box2D/collision/shapes/B2PolygonShape.hx",819);
		...
		HX_STACK_LINE(830)
		{
			...
			while(((_g1 < _g))){
				...
				int i1 = (_g1)++;		HX_STACK_VAR(i1,"i1");
				HX_STACK_LINE(832)
				::box2D::common::math::B2Vec2 root = p->__get(::Std_obj::_int((i1 - (int)1))).StaticCast< ::box2D::common::math::B2Vec2 >();		HX_STACK_VAR(root,"root");
				HX_STACK_LINE(834)
				...
				HX_STACK_LINE(848)
				Float upperX = -(1.7976931348623158e+308);		HX_STACK_VAR(upperX,"upperX");
				HX_STACK_LINE(849)
				Float upperY = -(1.7976931348623158e+308);		HX_STACK_VAR(upperY,"upperY");
				HX_STACK_LINE(851)
				{
					HX_STACK_LINE(851)
