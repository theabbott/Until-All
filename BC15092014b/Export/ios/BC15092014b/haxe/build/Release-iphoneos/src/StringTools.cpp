...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_PUSH("StringTools::urlEncode","StringTools.hx",37);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(37)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_PUSH("StringTools::urlDecode","StringTools.hx",62);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(62)
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_PUSH("StringTools::startsWith","StringTools.hx",124);
	HX_STACK_ARG(s,"s");
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_PUSH("StringTools::replace","StringTools.hx",288);
	HX_STACK_ARG(s,"s");
