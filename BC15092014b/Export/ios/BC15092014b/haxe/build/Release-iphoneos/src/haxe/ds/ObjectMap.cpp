...
{
HX_STACK_PUSH("ObjectMap::new","haxe/ds/ObjectMap.hx",29);
{
	HX_STACK_LINE(29)
...
Dynamic ObjectMap_obj::iterator( ){
	HX_STACK_PUSH("ObjectMap::iterator","haxe/ds/ObjectMap.hx",57);
	HX_STACK_THIS(this);
	HX_STACK_LINE(57)
...
Dynamic ObjectMap_obj::keys( ){
	HX_STACK_PUSH("ObjectMap::keys","haxe/ds/ObjectMap.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(50)
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_PUSH("ObjectMap::get","haxe/ds/ObjectMap.hx",37);
	HX_STACK_THIS(this);
