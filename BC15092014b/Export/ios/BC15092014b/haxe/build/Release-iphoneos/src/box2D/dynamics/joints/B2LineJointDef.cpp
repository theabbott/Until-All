...
{
HX_STACK_PUSH("B2LineJointDef::new","box2D/dynamics/joints/B2LineJointDef.hx",38);
{
	HX_STACK_LINE(39)
	super::__construct();
	HX_STACK_LINE(40)
...
{
		HX_STACK_PUSH("B2LineJointDef::initialize","box2D/dynamics/joints/B2LineJointDef.hx",57);
		HX_STACK_THIS(this);
		HX_STACK_ARG(bA,"bA");
		HX_STACK_ARG(bB,"bB");
