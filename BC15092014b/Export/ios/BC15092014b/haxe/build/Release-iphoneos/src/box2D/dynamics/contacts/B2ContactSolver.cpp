...
{
HX_STACK_PUSH("B2ContactSolver::new","box2D/dynamics/contacts/B2ContactSolver.hx",43);
{
	HX_STACK_LINE(44)
	this->m_step = ::box2D::dynamics::B2TimeStep_obj::__new();
	HX_STACK_LINE(45)
	this->m_constraints = Array_obj< ::Dynamic >::__new();
}
;
	return null();
}
...
bool B2ContactSolver_obj::solvePositionConstraints( Float baumgarte){
	HX_STACK_PUSH("B2ContactSolver::solvePositionConstraints","box2D/dynamics/contacts/B2ContactSolver.hx",864);
	HX_STACK_THIS(this);
		...
		while(((_g1 < _g))){
			...
			HX_STACK_LINE(883)
			{
				...
				while(((_g3 < _g2))){
					...
					HX_STACK_LINE(896)
					minSeparation = (  (((minSeparation < separation))) ? Float(minSeparation) : Float(separation) );
					HX_STACK_LINE(899)
...
{
		HX_STACK_PUSH("B2ContactSolver::finalizeVelocityConstraints","box2D/dynamics/contacts/B2ContactSolver.hx",742);
		HX_STACK_THIS(this);
		HX_STACK_LINE(743)
		int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
		int _g = this->m_constraintCount;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_PUSH("B2ContactSolver::solveVelocityConstraints","box2D/dynamics/contacts/B2ContactSolver.hx",287);
		HX_STACK_THIS(this);
		HX_STACK_LINE(288)
		...
		HX_STACK_LINE(313)
		{
			...
			while(((_g1 < _g))){
				...
				if (((c->pointCount == (int)1))){
					...
					HX_STACK_LINE(391)
					newImpulse = (  (((newImpulse > (int)0))) ? Float(newImpulse) : Float(0.0) );
					HX_STACK_LINE(392)
...
{
		HX_STACK_PUSH("B2ContactSolver::initVelocityConstraints","box2D/dynamics/contacts/B2ContactSolver.hx",224);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("B2ContactSolver::initialize","box2D/dynamics/contacts/B2ContactSolver.hx",50);
		HX_STACK_THIS(this);
		HX_STACK_ARG(step,"step");
		...
		HX_STACK_LINE(69)
		{
			...
			while(((_g < contactCount))){
				...
				HX_STACK_LINE(82)
				Float friction = ::box2D::common::B2Settings_obj::b2MixFriction(fixtureA->getFriction(),fixtureB->getFriction());		HX_STACK_VAR(friction,"friction");
				HX_STACK_LINE(83)
				Float restitution = ::box2D::common::B2Settings_obj::b2MixRestitution(fixtureA->getRestitution(),fixtureB->getRestitution());		HX_STACK_VAR(restitution,"restitution");
				HX_STACK_LINE(86)
				...
				HX_STACK_LINE(119)
				{
					...
					while(((_g2 < _g1))){
						...
						{
							HX_STACK_LINE(127)
							::box2D::common::math::B2Vec2 _this = ccp->localPoint;		HX_STACK_VAR(_this,"_this");
							::box2D::common::math::B2Vec2 v = cp->m_localPoint;		HX_STACK_VAR(v,"v");
							HX_STACK_LINE(127)
							_this->x = v->x;
							HX_STACK_LINE(127)
							_this->y = v->y;
				...
				if (((cc->pointCount == (int)2))){
					...
					if ((((k11 * k11) < (k_maxConditionNumber * (((k11 * k22) - (k12 * k12))))))){
						...
						{
							HX_STACK_LINE(207)
							::box2D::common::math::B2Vec2 _this = cc->K->col1;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(207)
							_this->x = k11;
							HX_STACK_LINE(207)
							_this->y = k12;
						...
						{
							HX_STACK_LINE(208)
							::box2D::common::math::B2Vec2 _this = cc->K->col2;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(208)
							_this->x = k12;
							HX_STACK_LINE(208)
							_this->y = k22;
