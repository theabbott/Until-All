...
::Class Type_obj::getClass( Dynamic o){
	HX_STACK_PUSH("Type::getClass","Type.hx",35);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(36)
...
::String Type_obj::getEnumName( ::Enum e){
	HX_STACK_PUSH("Type::getEnumName","Type.hx",62);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(62)
	return e->__ToString();
}
...
::Class Type_obj::resolveClass( ::String name){
	HX_STACK_PUSH("Type::resolveClass","Type.hx",66);
...
::Enum Type_obj::resolveEnum( ::String name){
	HX_STACK_PUSH("Type::resolveEnum","Type.hx",73);
	HX_STACK_ARG(name,"name");
	HX_STACK_LINE(74)
	::Class result = ::Class_obj::Resolve(name);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(75)
...
Dynamic Type_obj::createInstance( ::Class cl,Dynamic args){
	HX_STACK_PUSH("Type::createInstance","Type.hx",80);
	HX_STACK_ARG(cl,"cl");
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	HX_STACK_PUSH("Type::createEmptyInstance","Type.hx",86);
	HX_STACK_ARG(cl,"cl");
	HX_STACK_LINE(86)
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Dynamic params){
	HX_STACK_PUSH("Type::createEnumIndex","Type.hx",94);
	HX_STACK_ARG(e,"e");
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	HX_STACK_PUSH("Type::getEnumConstructs","Type.hx",108);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(108)
...
::ValueType Type_obj::_typeof( Dynamic v){
	HX_STACK_PUSH("Type::typeof","Type.hx",112);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(113)
	if (((v == null()))){
		HX_STACK_LINE(113)
