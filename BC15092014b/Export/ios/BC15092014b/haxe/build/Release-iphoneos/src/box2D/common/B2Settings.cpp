...
Float B2Settings_obj::b2MixFriction( Float friction1,Float friction2){
	HX_STACK_PUSH("B2Settings::b2MixFriction","box2D/common/B2Settings.hx",149);
...
Float B2Settings_obj::b2MixRestitution( Float restitution1,Float restitution2){
	HX_STACK_PUSH("B2Settings::b2MixRestitution","box2D/common/B2Settings.hx",157);
	HX_STACK_ARG(restitution1,"restitution1");
	HX_STACK_ARG(restitution2,"restitution2");
	HX_STACK_LINE(157)
	return (  (((restitution1 > restitution2))) ? Float(restitution1) : Float(restitution2) );
}
...
{
		HX_STACK_PUSH("B2Settings::b2Assert","box2D/common/B2Settings.hx",184);
		HX_STACK_ARG(a,"a");
		HX_STACK_LINE(184)
		if ((!(a))){
			HX_STACK_LINE(185)
...
void B2Settings_obj::__Visit(HX_VISIT_PARAMS)
{
}
...
void B2Settings_obj::__boot()
{
	...
	b2_linearSlop= 0.005;
	b2_polygonRadius= (2.0 * ::box2D::common::B2Settings_obj::b2_linearSlop);
	b2_angularSlop= ((Float(2.0) / Float(180.0)) * ::box2D::common::B2Settings_obj::b2_pi);
	b2_toiSlop= (8.0 * ::box2D::common::B2Settings_obj::b2_linearSlop);
	b2_maxTOIContactsPerIsland= (int)32;
	b2_maxTOIJointsPerIsland= (int)32;
	b2_velocityThreshold= 1.0;
	b2_maxLinearCorrection= 0.2;
	b2_maxAngularCorrection= ((Float(8.0) / Float(180.0)) * ::box2D::common::B2Settings_obj::b2_pi);
	b2_maxTranslation= 2.0;
	b2_maxTranslationSquared= (::box2D::common::B2Settings_obj::b2_maxTranslation * ::box2D::common::B2Settings_obj::b2_maxTranslation);
	b2_maxRotation= (0.5 * ::box2D::common::B2Settings_obj::b2_pi);
	b2_maxRotationSquared= (::box2D::common::B2Settings_obj::b2_maxRotation * ::box2D::common::B2Settings_obj::b2_maxRotation);
	b2_contactBaumgarte= 0.2;
	b2_timeToSleep= 0.5;
	b2_linearSleepTolerance= 0.01;
	b2_angularSleepTolerance= ((Float(2.0) / Float(180.0)) * ::box2D::common::B2Settings_obj::b2_pi);
}
