...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("Stencyl"),HX_CSTRING("BC15092014b"),HX_CSTRING("hk.com.playpenstudios.untilall"),HX_CSTRING("1.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_2","ApplicationMain.hx",31);
			{
				...
				{
					HX_STACK_LINE(40)
					::ApplicationMain_obj::forceWidth = (int)320;
					HX_STACK_LINE(41)
					::ApplicationMain_obj::forceHeight = (int)480;
					HX_STACK_LINE(43)
				...
				HX_STACK_LINE(69)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::Universal >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(69)
					while(((_g < _g1->length))){
						HX_STACK_LINE(69)
				...
				if ((hasMain)){
					HX_STACK_LINE(80)
					::Reflect_obj::callMethod(hx::ClassOf< ::Universal >(),::Reflect_obj::field(hx::ClassOf< ::Universal >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(86)
		...
		HX_STACK_LINE(31)
		::flash::Lib_obj::create( Dynamic(new _Function_1_2()),(int)320,(int)480,(int)65,(int)0,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int(::flash::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::VSYNC))) | int(::flash::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("Unitl All"),null(),hx::ClassOf< ::ScaledStage >());
	}
return null();
}
