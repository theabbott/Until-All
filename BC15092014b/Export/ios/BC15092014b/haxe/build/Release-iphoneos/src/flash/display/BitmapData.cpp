...
bool BitmapData_obj::get_transparent( ){
	HX_STACK_PUSH("BitmapData::get_transparent","flash/display/BitmapData.hx",664);
	HX_STACK_THIS(this);
	HX_STACK_LINE(664)
...
int BitmapData_obj::get_height( ){
	HX_STACK_PUSH("BitmapData::get_height","flash/display/BitmapData.hx",663);
	HX_STACK_THIS(this);
	HX_STACK_LINE(663)
...
int BitmapData_obj::get_width( ){
	HX_STACK_PUSH("BitmapData::get_width","flash/display/BitmapData.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_LINE(662)
...
::flash::geom::Rectangle BitmapData_obj::get_rect( ){
	HX_STACK_PUSH("BitmapData::get_rect","flash/display/BitmapData.hx",661);
	HX_STACK_THIS(this);
	HX_STACK_LINE(661)
...
{
		HX_STACK_PUSH("BitmapData::__loadFromBytes","flash/display/BitmapData.hx",593);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::__drawToSurface","flash/display/BitmapData.hx",579);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::unmultiplyAlpha","flash/display/BitmapData.hx",572);
		HX_STACK_THIS(this);
		HX_STACK_LINE(572)
		::flash::display::BitmapData_obj::nme_bitmap_data_unmultiply_alpha(this->__handle);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::unlock","flash/display/BitmapData.hx",565);
		HX_STACK_THIS(this);
...
bool copySource = __o_copySource.Default(false);
	HX_STACK_PUSH("BitmapData::threshold","flash/display/BitmapData.hx",414);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setVector","flash/display/BitmapData.hx",392);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setPixels","flash/display/BitmapData.hx",382);
		HX_STACK_THIS(this);
		HX_STACK_ARG(rect,"rect");
		HX_STACK_ARG(pixels,"pixels");
		HX_STACK_LINE(384)
...
{
		HX_STACK_PUSH("BitmapData::setPixel32","flash/display/BitmapData.hx",375);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_ARG(color,"color");
...
{
		HX_STACK_PUSH("BitmapData::setPixel","flash/display/BitmapData.hx",368);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_ARG(color,"color");
...
{
		HX_STACK_PUSH("BitmapData::setFormat","flash/display/BitmapData.hx",361);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setFlags","flash/display/BitmapData.hx",353);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::scroll","flash/display/BitmapData.hx",346);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_LINE(346)
...
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_PUSH("BitmapData::perlinNoise","flash/display/BitmapData.hx",331);
	HX_STACK_THIS(this);
...
int channelOptions = __o_channelOptions.Default(7);
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_PUSH("BitmapData::noise","flash/display/BitmapData.hx",324);
	HX_STACK_THIS(this);
	HX_STACK_ARG(randomSeed,"randomSeed");
...
Void BitmapData_obj::dispose( ){
{
		...
		if (((this->__handle != null()))){
			HX_STACK_LINE(137)
			::flash::display::BitmapData_obj::nme_bitmap_data_dispose(this->__handle);
		}
		HX_STACK_LINE(143)
		this->__handle = null();
	}
...
bool BitmapData_obj::sameValue( int a,int b){
	HX_STACK_PUSH("BitmapData::sameValue","flash/display/BitmapData.hx",339);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(339)
	return (a == b);
...
int BitmapData_obj::__flipPixel( int pixel){
	HX_STACK_PUSH("BitmapData::__flipPixel","flash/display/BitmapData.hx",586);
...
int BitmapData_obj::__ucompare( int n1,int n2){
	HX_STACK_PUSH("BitmapData::__ucompare","flash/display/BitmapData.hx",600);
	HX_STACK_ARG(n1,"n1");
	HX_STACK_ARG(n2,"n2");
	HX_STACK_LINE(602)
...
Dynamic BitmapData_obj::nme_bitmap_data_dispose;
...
Dynamic BitmapData_obj::nme_bitmap_data_unmultiply_alpha;
...
Dynamic BitmapData_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 22:
		...
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"nme_bitmap_data_dispose") ) { return nme_bitmap_data_dispose; }
		break;
	case 25:
	...
	case 31:
		...
		break;
	case 32:
		if (HX_FIELD_EQ(inName,"nme_bitmap_data_unmultiply_alpha") ) { return nme_bitmap_data_unmultiply_alpha; }
		break;
	case 36:
...
Dynamic BitmapData_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 22:
		...
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"nme_bitmap_data_dispose") ) { nme_bitmap_data_dispose=inValue.Cast< Dynamic >(); return inValue; }
		break;
	case 25:
	...
	case 31:
		...
		break;
	case 32:
		if (HX_FIELD_EQ(inName,"nme_bitmap_data_unmultiply_alpha") ) { nme_bitmap_data_unmultiply_alpha=inValue.Cast< Dynamic >(); return inValue; }
		break;
	case 36:
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("nme_bitmap_data_dispose"),
	...
	HX_CSTRING("nme_bitmap_data_unmultiply_alpha"),
	String(null()) };
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(BitmapData_obj::nme_bitmap_data_unmultiply_alpha,"nme_bitmap_data_unmultiply_alpha");
};
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(BitmapData_obj::nme_bitmap_data_unmultiply_alpha,"nme_bitmap_data_unmultiply_alpha");
};
...
void BitmapData_obj::__boot()
{
	...
	nme_bitmap_data_dispose= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_dispose"),(int)1);
	...
	nme_bitmap_data_unmultiply_alpha= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_unmultiply_alpha"),(int)1);
}
