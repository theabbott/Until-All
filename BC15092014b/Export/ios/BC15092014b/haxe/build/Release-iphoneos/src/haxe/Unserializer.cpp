...
{
HX_STACK_PUSH("Unserializer::new","haxe/Unserializer.hx",96);
{
	HX_STACK_LINE(97)
	this->buf = buf;
	HX_STACK_LINE(98)
...
Dynamic Unserializer_obj::unserialize( ){
	HX_STACK_PUSH("Unserializer::unserialize","haxe/Unserializer.hx",216);
	HX_STACK_THIS(this);
	HX_STACK_LINE(217)
	{
		HX_STACK_LINE(217)
			...
			case (int)111: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_PUSH("*::closure","haxe/Unserializer.hx",273);
						{
...
Dynamic Unserializer_obj::unserializeEnum( ::Enum edecl,::String tag){
	HX_STACK_PUSH("Unserializer::unserializeEnum","haxe/Unserializer.hx",184);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Unserializer::unserializeObject","haxe/Unserializer.hx",169);
		HX_STACK_THIS(this);
		HX_STACK_ARG(o,"o");
		HX_STACK_LINE(170)
		while((true)){
...
int Unserializer_obj::readDigits( ){
	HX_STACK_PUSH("Unserializer::readDigits","haxe/Unserializer.hx",144);
	HX_STACK_THIS(this);
	HX_STACK_LINE(145)
...
{
		HX_STACK_PUSH("Unserializer::setResolver","haxe/Unserializer.hx",121);
		HX_STACK_THIS(this);
		HX_STACK_ARG(r,"r");
		HX_STACK_LINE(121)
		if (((r == null()))){
			struct _Function_2_1{
				inline static Dynamic Block( ){
					HX_STACK_PUSH("*::closure","haxe/Unserializer.hx",123);
					{
						hx::Anon __result = hx::Anon_obj::Create();

						HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_3_1)
						::Class run(::String _){
							HX_STACK_PUSH("*::_Function_3_1","haxe/Unserializer.hx",124);
							HX_STACK_ARG(_,"_");
							{
								HX_STACK_LINE(124)
								return null();
						...
						::Enum run(::String _){
							HX_STACK_PUSH("*::_Function_3_2","haxe/Unserializer.hx",125);
							HX_STACK_ARG(_,"_");
							{
								HX_STACK_LINE(125)
								return null();
...
Array< int > Unserializer_obj::initCodes( ){
	HX_STACK_PUSH("Unserializer::initCodes","haxe/Unserializer.hx",64);
	HX_STACK_LINE(65)
...
Dynamic Unserializer_obj::run( ::String v){
	HX_STACK_PUSH("Unserializer::run","haxe/Unserializer.hx",430);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(430)
