...
{
HX_STACK_PUSH("B2Mat33::new","box2D/common/math/B2Mat33.hx",28);
{
	HX_STACK_LINE(30)
...
::box2D::common::math::B2Vec3 B2Mat33_obj::solve33( ::box2D::common::math::B2Vec3 out,Float bX,Float bY,Float bZ){
	HX_STACK_PUSH("B2Mat33::solve33","box2D/common/math/B2Mat33.hx",115);
	HX_STACK_THIS(this);
...
::box2D::common::math::B2Vec2 B2Mat33_obj::solve22( ::box2D::common::math::B2Vec2 out,Float bX,Float bY){
	HX_STACK_PUSH("B2Mat33::solve22","box2D/common/math/B2Mat33.hx",95);
	HX_STACK_THIS(this);
	HX_STACK_ARG(out,"out");
	HX_STACK_ARG(bX,"bX");
	HX_STACK_ARG(bY,"bY");
...
{
		HX_STACK_PUSH("B2Mat33::setZero","box2D/common/math/B2Mat33.hx",87);
		HX_STACK_THIS(this);
		HX_STACK_LINE(88)
		this->col1->x = 0.0;
		HX_STACK_LINE(88)
...
{
		HX_STACK_PUSH("B2Mat33::setIdentity","box2D/common/math/B2Mat33.hx",80);
		HX_STACK_THIS(this);
		HX_STACK_LINE(81)
		this->col1->x = 1.0;
		HX_STACK_LINE(81)
...
{
		HX_STACK_PUSH("B2Mat33::addM","box2D/common/math/B2Mat33.hx",67);
		HX_STACK_THIS(this);
		HX_STACK_ARG(m,"m");
		HX_STACK_LINE(68)
...
{
		HX_STACK_PUSH("B2Mat33::setM","box2D/common/math/B2Mat33.hx",60);
		HX_STACK_THIS(this);
		HX_STACK_ARG(m,"m");
		HX_STACK_LINE(61)
...
::box2D::common::math::B2Mat33 B2Mat33_obj::copy( ){
	HX_STACK_PUSH("B2Mat33::copy","box2D/common/math/B2Mat33.hx",55);
	HX_STACK_THIS(this);
	HX_STACK_LINE(55)
...
{
		HX_STACK_PUSH("B2Mat33::setVVV","box2D/common/math/B2Mat33.hx",49);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c1,"c1");
		HX_STACK_ARG(c2,"c2");
		HX_STACK_ARG(c3,"c3");
