...
{
HX_STACK_PUSH("Sound::new","flash/media/Sound.hx",33);
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
{
	HX_STACK_LINE(35)
	super::__construct(null());
	HX_STACK_LINE(37)
	this->__audioType = (  ((forcePlayAsMusic)) ? ::flash::media::InternalAudioType(::flash::media::InternalAudioType_obj::MUSIC) : ::flash::media::InternalAudioType(::flash::media::InternalAudioType_obj::SOUND) );
	HX_STACK_LINE(39)
...
Float Sound_obj::get_length( ){
	HX_STACK_PUSH("Sound::get_length","flash/media/Sound.hx",292);
	HX_STACK_THIS(this);
	HX_STACK_LINE(294)
...
bool Sound_obj::get_isBuffering( ){
	HX_STACK_PUSH("Sound::get_isBuffering","flash/media/Sound.hx",284);
	HX_STACK_THIS(this);
	HX_STACK_LINE(286)
	this->__checkLoading();
	HX_STACK_LINE(287)
...
::flash::media::ID3Info Sound_obj::get_id3( ){
	HX_STACK_PUSH("Sound::get_id3","flash/media/Sound.hx",267);
	HX_STACK_THIS(this);
	HX_STACK_LINE(269)
	this->__checkLoading();
	HX_STACK_LINE(271)
...
{
		HX_STACK_PUSH("Sound::__onError","flash/media/Sound.hx",251);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sound::__checkLoading","flash/media/Sound.hx",224);
		HX_STACK_THIS(this);
		HX_STACK_LINE(224)
...
int loops = __o_loops.Default(0);
	HX_STACK_PUSH("Sound::play","flash/media/Sound.hx",175);
	HX_STACK_THIS(this);
...
Float sampleRate = __o_sampleRate.Default(44100.0);
	HX_STACK_PUSH("Sound::loadPCMFromByteArray","flash/media/Sound.hx",127);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(sampleRate,"sampleRate");
{
		...
		struct _Function_1_1{
			inline static int Block( ::String &format){
				HX_STACK_PUSH("*::closure","flash/media/Sound.hx",132);
				{
					HX_STACK_LINE(132)
...
;
		...
		struct _Function_1_2{
			inline static int Block( ::String &format){
				HX_STACK_PUSH("*::closure","flash/media/Sound.hx",142);
				{
					HX_STACK_LINE(142)
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_PUSH("Sound::loadCompressedDataFromByteArray","flash/media/Sound.hx",111);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bytes,"bytes");
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_PUSH("Sound::load","flash/media/Sound.hx",87);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sound::close","flash/media/Sound.hx",73);
		HX_STACK_THIS(this);
		HX_STACK_LINE(75)
		if (((this->__handle != null()))){
			HX_STACK_LINE(75)
...
bool useWeakReference = __o_useWeakReference.Default(false);
	HX_STACK_PUSH("Sound::addEventListener","flash/media/Sound.hx",53);
	HX_STACK_THIS(this);
