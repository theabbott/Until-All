...
{
HX_STACK_PUSH("B2PulleyJoint::new","box2D/dynamics/joints/B2PulleyJoint.hx",129);
{
	HX_STACK_LINE(132)
	...
	HX_STACK_LINE(166)
	this->m_maxLength2 = ::box2D::common::math::B2Math_obj::min(def->maxLengthB,(Float(((this->m_constant - ::box2D::dynamics::joints::B2PulleyJoint_obj::b2_minPulleyLength))) / Float(this->m_ratio)));
	HX_STACK_LINE(168)
	this->m_impulse = 0.0;
	HX_STACK_LINE(169)
...
bool B2PulleyJoint_obj::solvePositionConstraints( Float baumgarte){
	HX_STACK_PUSH("B2PulleyJoint::solvePositionConstraints","box2D/dynamics/joints/B2PulleyJoint.hx",437);
	HX_STACK_THIS(this);
	...
	if (((this->m_state == ::box2D::dynamics::joints::B2Joint_obj::e_atUpperLimit))){
		...
		{
			HX_STACK_LINE(498)
			::box2D::common::math::B2Vec2 _this = this->m_u1;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(498)
			_this->x = (p1X - s1X);
			HX_STACK_LINE(498)
			_this->y = (p1Y - s1Y);
		...
		{
			HX_STACK_LINE(500)
			::box2D::common::math::B2Vec2 _this = this->m_u2;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(500)
			_this->x = (p2X - s2X);
			HX_STACK_LINE(500)
			_this->y = (p2Y - s2Y);
...
{
		HX_STACK_PUSH("B2PulleyJoint::solveVelocityConstraints","box2D/dynamics/joints/B2PulleyJoint.hx",319);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("B2PulleyJoint::initVelocityConstraints","box2D/dynamics/joints/B2PulleyJoint.hx",174);
		HX_STACK_THIS(this);
		HX_STACK_ARG(step,"step");
		HX_STACK_LINE(175)
		::box2D::dynamics::B2Body bA = this->m_bodyA;		HX_STACK_VAR(bA,"bA");
...
Float B2PulleyJoint_obj::getRatio( ){
	HX_STACK_PUSH("B2PulleyJoint::getRatio","box2D/dynamics/joints/B2PulleyJoint.hx",122);
	HX_STACK_THIS(this);
	HX_STACK_LINE(122)
	return this->m_ratio;
}
...
Float B2PulleyJoint_obj::getLength2( ){
	HX_STACK_PUSH("B2PulleyJoint::getLength2","box2D/dynamics/joints/B2PulleyJoint.hx",107);
	HX_STACK_THIS(this);
	HX_STACK_LINE(108)
...
Float B2PulleyJoint_obj::getLength1( ){
	HX_STACK_PUSH("B2PulleyJoint::getLength1","box2D/dynamics/joints/B2PulleyJoint.hx",91);
	HX_STACK_THIS(this);
	HX_STACK_LINE(92)
...
::box2D::common::math::B2Vec2 B2PulleyJoint_obj::getGroundAnchorB( ){
	HX_STACK_PUSH("B2PulleyJoint::getGroundAnchorB","box2D/dynamics/joints/B2PulleyJoint.hx",80);
	HX_STACK_THIS(this);
	HX_STACK_LINE(82)
	::box2D::common::math::B2Vec2 a = this->m_ground->m_xf->position->copy(null());		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(83)
...
::box2D::common::math::B2Vec2 B2PulleyJoint_obj::getGroundAnchorA( ){
	HX_STACK_PUSH("B2PulleyJoint::getGroundAnchorA","box2D/dynamics/joints/B2PulleyJoint.hx",69);
	HX_STACK_THIS(this);
	HX_STACK_LINE(71)
	::box2D::common::math::B2Vec2 a = this->m_ground->m_xf->position->copy(null());		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(72)
...
Float B2PulleyJoint_obj::getReactionTorque( Float inv_dt){
	HX_STACK_PUSH("B2PulleyJoint::getReactionTorque","box2D/dynamics/joints/B2PulleyJoint.hx",60);
	HX_STACK_THIS(this);
...
::box2D::common::math::B2Vec2 B2PulleyJoint_obj::getReactionForce( Float inv_dt){
	HX_STACK_PUSH("B2PulleyJoint::getReactionForce","box2D/dynamics/joints/B2PulleyJoint.hx",52);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inv_dt,"inv_dt");
	HX_STACK_LINE(52)
...
::box2D::common::math::B2Vec2 B2PulleyJoint_obj::getAnchorB( ){
	HX_STACK_PUSH("B2PulleyJoint::getAnchorB","box2D/dynamics/joints/B2PulleyJoint.hx",46);
	HX_STACK_THIS(this);
	HX_STACK_LINE(46)
...
::box2D::common::math::B2Vec2 B2PulleyJoint_obj::getAnchorA( ){
	HX_STACK_PUSH("B2PulleyJoint::getAnchorA","box2D/dynamics/joints/B2PulleyJoint.hx",42);
	HX_STACK_THIS(this);
	HX_STACK_LINE(42)
