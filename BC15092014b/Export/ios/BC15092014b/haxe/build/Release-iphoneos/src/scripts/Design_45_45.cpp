...
Void Design_45_45_obj::__construct(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine)
{
HX_STACK_PUSH("Design_45_45::new","scripts/Design_45_45.hx",157);
{
	HX_STACK_LINE(158)
...
Design_45_45_obj::~Design_45_45_obj() { }

Dynamic Design_45_45_obj::__CreateEmpty() { return  new Design_45_45_obj; }
hx::ObjectPtr< Design_45_45_obj > Design_45_45_obj::__new(int dummy,::com::stencyl::models::Actor actor,::com::stencyl::Engine engine)
{  hx::ObjectPtr< Design_45_45_obj > result = new Design_45_45_obj();
	result->__construct(dummy,actor,engine);
	return result;}

Dynamic Design_45_45_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Design_45_45_obj > result = new Design_45_45_obj();
	result->__construct(inArgs[0],inArgs[1],inArgs[2]);
	return result;}

Void Design_45_45_obj::forwardMessage( ::String msg){
{
		HX_STACK_PUSH("Design_45_45::forwardMessage","scripts/Design_45_45.hx",292);
		HX_STACK_THIS(this);
...
Void Design_45_45_obj::init( ){
{
		HX_STACK_PUSH("Design_45_45::init","scripts/Design_45_45.hx",209);
		HX_STACK_THIS(this);
		HX_STACK_LINE(208)
		...
		Void run(Float elapsedTime,Dynamic list){
			HX_STACK_PUSH("*::_Function_1_1","scripts/Design_45_45.hx",212);
			HX_STACK_ARG(elapsedTime,"elapsedTime");
			HX_STACK_ARG(list,"list");
			{
				HX_STACK_LINE(212)
				if ((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->wrapper->enabled)){
					HX_STACK_LINE(213)
					if ((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_Activated)){
						HX_STACK_LINE(215)
						if ((!(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_HandleParticle))){
							HX_STACK_LINE(218)
							_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_HandleParticle = true;
							HX_STACK_LINE(219)
							_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->propertyChanged(HX_CSTRING("_HandleParticle"),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_HandleParticle);
							HX_STACK_LINE(221)
							if ((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_RandomParticles)){
								HX_STACK_LINE(223)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleName = ((HX_CSTRING("") + _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleList->__GetItem(::Std_obj::_int(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->randomInt(::Math_obj::floor((int)0),::Math_obj::floor((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleList->__Field(HX_CSTRING("length"),true) - (int)1))))))).split(HX_CSTRING(","))->__get((int)0);
								HX_STACK_LINE(224)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->propertyChanged(HX_CSTRING("_ParticleName"),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleName);
								HX_STACK_LINE(225)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleType = _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getActorTypeByName(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleName);
								HX_STACK_LINE(226)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleAnimation = ((HX_CSTRING("") + _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleList->__GetItem(::Std_obj::_int(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->randomInt(::Math_obj::floor((int)0),::Math_obj::floor((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleList->__Field(HX_CSTRING("length"),true) - (int)1))))))).split(HX_CSTRING(","))->__get((int)1);
								HX_STACK_LINE(227)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->propertyChanged(HX_CSTRING("_ParticleAnimation"),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleAnimation);
							}
							HX_STACK_LINE(230)
							if (((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_SpawnModes == HX_CSTRING("Random")))){
								HX_STACK_LINE(231)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->createRecycledActor(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleType,(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getX(null()) + _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->randomInt(::Math_obj::floor(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_XMinimumOffset),::Math_obj::floor(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_XMaximumOffset))),(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getY(null()) + _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->randomInt(::Math_obj::floor(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_YMinimumOffset),::Math_obj::floor(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_YMaximumOffset))),::com::stencyl::behavior::Script_obj::FRONT);
							}
							HX_STACK_LINE(235)
							if (((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_SpawnModes == HX_CSTRING("Perimeter")))){
								struct _Function_6_1{
									inline static Float Block( Array< ::Dynamic > &_g){
										HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",237);
										{
											HX_STACK_LINE(237)
											Dynamic o = _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->randomInt(::Math_obj::floor((int)0),::Math_obj::floor((int)360));		HX_STACK_VAR(o,"o");
								...
								HX_STACK_LINE(237)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_RandomAngle = _Function_6_1::Block(_g);
								HX_STACK_LINE(238)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->propertyChanged(HX_CSTRING("_RandomAngle"),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_RandomAngle);
								HX_STACK_LINE(239)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->createRecycledActor(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleType,(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getXCenter() + (_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_Radius * ::Math_obj::cos((((Float(3.1415926535897) / Float((int)180)) * _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_RandomAngle) * ((Float(3.1415926535897) / Float((int)180))))))),(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getYCenter() + (_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_Radius * ::Math_obj::sin((((Float(3.1415926535897) / Float((int)180)) * _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_RandomAngle) * ((Float(3.1415926535897) / Float((int)180))))))),::com::stencyl::behavior::Script_obj::FRONT);
								HX_STACK_LINE(240)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->setX((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getX(null()) - (Float(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getWidth()) / Float((int)2))),null(),null());
								HX_STACK_LINE(241)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->setY((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getY(null()) - (Float(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getHeight()) / Float((int)2))),null(),null());
							}
							HX_STACK_LINE(244)
							_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->setAnimation((HX_CSTRING("") + ((HX_CSTRING("") + _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleAnimation))));
							HX_STACK_LINE(246)
							if ((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_RandomSpeed)){
								struct _Function_6_1{
									inline static Float Block( Array< ::Dynamic > &_g){
										HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",248);
										{
											HX_STACK_LINE(248)
											Dynamic o = _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->randomInt(::Math_obj::floor(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_MinimumParticleForce),::Math_obj::floor(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_MaximumParticleForce));		HX_STACK_VAR(o,"o");
											struct _Function_7_1{
												inline static int Block( Dynamic &o){
													HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",248);
													{
								...
								HX_STACK_LINE(248)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleForce = _Function_6_1::Block(_g);
								HX_STACK_LINE(249)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->propertyChanged(HX_CSTRING("_ParticleForce"),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleForce);
							}
							else{
								struct _Function_6_1{
									inline static Float Block( Array< ::Dynamic > &_g){
										HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",254);
										{
											HX_STACK_LINE(254)
											Dynamic o = _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_MaximumParticleForce;		HX_STACK_VAR(o,"o");
											struct _Function_7_1{
												inline static int Block( Dynamic &o){
													HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",254);
													{
							...
							HX_STACK_LINE(258)
							if (((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_MovementMode == HX_CSTRING("To Angle")))){
								HX_STACK_LINE(259)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->applyImpulseInDirection(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_AngletoMove,_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleForce);
							}
							HX_STACK_LINE(263)
							if (((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_MovementMode == HX_CSTRING("Expand")))){
								HX_STACK_LINE(264)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->applyImpulseInDirection(((Float((int)180) / Float(3.1415926535897)) * ::Math_obj::atan2((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getYCenter() - _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getYCenter()),(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getXCenter() - _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getXCenter()))),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleForce);
							}
							HX_STACK_LINE(268)
							if (((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_MovementMode == HX_CSTRING("To Center")))){
								HX_STACK_LINE(269)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->applyImpulseInDirection(((Float((int)180) / Float(3.1415926535897)) * ::Math_obj::atan2((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getYCenter() - _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getYCenter()),(_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getXCenter() - _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getXCenter()))),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleForce);
							}
							HX_STACK_LINE(273)
							if (((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_MovementMode == HX_CSTRING("To Point")))){
								HX_STACK_LINE(274)
								_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->applyImpulseInDirection(((Float((int)180) / Float(3.1415926535897)) * ::Math_obj::atan2(((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getY(null()) + _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ToPointYOffset) - _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getYCenter()),((_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor->getX(null()) + _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ToPointXOffset) - _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->getLastCreatedActor()->getXCenter()))),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleForce);
							}

							HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_5_1,Array< ::Dynamic >,_g)
							Void run(::com::stencyl::behavior::TimedTask timeTask){
								HX_STACK_PUSH("*::_Function_5_1","scripts/Design_45_45.hx",278);
								HX_STACK_ARG(timeTask,"timeTask");
								{
									HX_STACK_LINE(279)
									_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_HandleParticle = false;
									HX_STACK_LINE(280)
									_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->propertyChanged(HX_CSTRING("_HandleParticle"),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_HandleParticle);
								}
								return null();
							...
							HX_STACK_LINE(278)
							_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->runLater(((int)1000 * _g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->_ParticleDelay), Dynamic(new _Function_5_1(_g)),_g->__get((int)0).StaticCast< ::scripts::Design_45_45 >()->actor);
						}
					}
				}
			}
...
Void Design_45_45_obj::_customBlock_EmitParticles( ::com::stencyl::models::actor::ActorType __Particle,Float __MinX,Float __MaxX,Float __MinY,Float __MaxY,Float __Angle,Float __Delay,Float __Force){
{
		HX_STACK_PUSH("Design_45_45::_customBlock_EmitParticles","scripts/Design_45_45.hx",131);
		HX_STACK_THIS(this);
		...
		struct _Function_1_1{
			inline static int Block( Float &__MinX){
				HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",134);
				{
					HX_STACK_LINE(134)
		...
		struct _Function_1_3{
			inline static int Block( Float &__MaxX){
				HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",136);
				{
					HX_STACK_LINE(136)
		...
		struct _Function_1_5{
			inline static int Block( Float &__MinY){
				HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",138);
				{
					HX_STACK_LINE(138)
		...
		struct _Function_1_7{
			inline static int Block( Float &__MaxY){
				HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",140);
				{
					HX_STACK_LINE(140)
		...
		struct _Function_1_9{
			inline static int Block( Float &__Angle){
				HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",146);
				{
					HX_STACK_LINE(146)
		...
		struct _Function_1_11{
			inline static Float Block( ::scripts::Design_45_45_obj *__this){
				HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",148);
				{
					HX_STACK_LINE(148)
		...
		struct _Function_1_12{
			inline static int Block( Float &__Force){
				HX_STACK_PUSH("*::closure","scripts/Design_45_45.hx",150);
				{
					HX_STACK_LINE(150)
...
HX_DEFINE_DYNAMIC_FUNC8(Design_45_45_obj,_customBlock_EmitParticles,(void))

Void Design_45_45_obj::_customEvent_StartEmitting( ){
{
		HX_STACK_PUSH("Design_45_45::_customEvent_StartEmitting","scripts/Design_45_45.hx",120);
		HX_STACK_THIS(this);
		HX_STACK_LINE(121)
		this->_Activated = true;
		HX_STACK_LINE(122)
...
HX_DEFINE_DYNAMIC_FUNC0(Design_45_45_obj,_customEvent_StartEmitting,(void))

Void Design_45_45_obj::_customEvent_StopEmitting( ){
{
		HX_STACK_PUSH("Design_45_45::_customEvent_StopEmitting","scripts/Design_45_45.hx",114);
		HX_STACK_THIS(this);
		HX_STACK_LINE(115)
...
HX_DEFINE_DYNAMIC_FUNC0(Design_45_45_obj,_customEvent_StopEmitting,(void))
...
void Design_45_45_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Design_45_45);
...
void Design_45_45_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Design_45_45_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Design_45_45_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 7:
...
void Design_45_45_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Design_45_45_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Design_45_45_obj::__mClass,"__mClass");
};

Class Design_45_45_obj::__mClass;

void Design_45_45_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("scripts.Design_45_45"), hx::TCanCast< Design_45_45_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Design_45_45_obj::__boot()
{
}
