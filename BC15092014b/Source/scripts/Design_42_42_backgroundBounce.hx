...
class Design_42_42_backgroundBounce extends ActorScript
{          	
...
/* ======================== When Creating ========================= */
        runPeriodically(1000 * (60 / getGameAttribute("GameTempo")), function(timeTask:TimedTask):Void {
                    if((getValueForScene("MenuMetronome", "_Go") == true))
{
                        actor.setFilter([createNegativeFilter()]);
                        actor.growTo(20/100, 20/100, ((60 / getGameAttribute("GameTempo")) / 2), Linear.easeNone);
